...
In 2020, the COVID-19 pandemic spotlighted the urgency of internet access around the globe, especially in remote areas. COVID-19 lockdowns are temporary, but the under-connected population will have a lasting impact. Global internet is a need now.

Low-Earth Orbit (LEO) communication satellites recently pioneered by SpaceX's Starlink and other players demonstrated global internet is achievable. A steady flow of breakthroughs in rocket launchers, satellites, small chips, favorable social sentiment, and high investments positioned LEO satellite constellations in the righ trajectory. Latency around 30ms uniformly across globe is an incredible feature of this technology. Many published articles name remote area households, automated driving, data centers, supply chains including freight, agriculture as immediate benefactors of low latency global internet. We provide a walkthrough from LEO satellite constellation formation to satellite deactivation followed by a brief preview of benefits and challenges.
...
satellite size, satellite speed, radiofrequency, and satellite count vary with the orbit. For communication purposes, there are mainly two near earth orbits for satellites:
...
## LEO satellites
SpaceX LEO satellites are small satellites called Starlink satellites. A Starlink satellite weighs around 227kg to 260kg. It orbits in LEO with a lifespan of three to four years. While there are tens of components, a LEO satellite typically has these key components: two redundant solar flat panels to power the satellite thrusters for position adjustment in the orbit, high-power phased array antennas for ground communication over Ku and Ka bands Optical inter-satellite links, The phased array antennas shoot narrow beams to 27,000 kmph orbiting Earth. The satellites' orbits at 400km - 2000km above sea level.
